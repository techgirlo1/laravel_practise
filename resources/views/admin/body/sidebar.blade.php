                  ...
                  <li  class="has-sub active expand" >
                    ...
                    <ul  class="collapse show"  id="dashboard"
                      ...
                      <div class="sub-menu">
                            ...
                            <li  class="active" >
                              <a class="sidenav-item-link" href="{{url('insert')}}">
                            ...
                            <li  class="active" >
                              <a class="sidenav-item-link" href="{{url('insertabout')}}">
                            ...
                            <li  class="active" >
                              <a class="sidenav-item-link" href="{{url('insert_pics')}}">
                            ...
                            <li  class="active" >
                              <a class="sidenav-item-link" href="{{route('brand_insert')}}">
