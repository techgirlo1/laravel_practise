...
<head>
  ...
  <body class="bg-light-gray" id="body">
                      ...
                      <div class="col-md-12">
                        <div class="d-inline-block mr-3">
                          <label class="control control-checkbox">
                            <input type="checkbox" />
                            <div class="control-indicator" name="terms"></div>
          ...
          <div class="copyright pl-0">
            <p class="text-center">&copy; 2018 Copyright Easy learning Dashboard  by 
              <a class="text-primary" href="http://www.easylearning.com/" target="_blank">Habeebat</a>.
            </p>
          </div>
        </div>
</body>
